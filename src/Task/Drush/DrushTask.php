...
/**
 * I copied this task/class from https://github.com/acquia/blt/blob/11.x/src/Robo/Tasks/DrushTask.php.
 * I feel better and thank you for the excellent work done by Acquia.
 *
...
class DrushTask extends CommandStack {
  ...
  protected function init() {
    if ($this->getConfig()->get('drush.bin')) {
      $this->executable = str_replace(' ', '\\ ', $this->getConfig()
        ->get('drush.bin'));
    }
    else {
